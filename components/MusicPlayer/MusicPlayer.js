...
function MusicPlayer(props) {
    ...
    return (
        <div className={`bg-white dark:bg-dark300 sticky z-50 bottom-0`}>
            <div className="w-full h-16  mx-auto xl:container">
                <SongRange/>
                <div
                    className="grid  grid-cols-2 lg:grid-cols-3 justify-items-center text-xs font-semibold text-gray-500 px-2 md:px-4">
