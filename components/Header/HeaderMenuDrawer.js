...
export default function HeaderMenuDrawer({navigation}) {
    ...
    return (
        <>
            ...
            <Dialog as="div" className="fixed inset-0 flex z-40 lg:hidden" onClose={setOpen}>
                ...
                >
                    <div className="relative max-w-xs w-full bg-white dark:bg-dark300 shadow-xl pb-12 flex flex-col overflow-y-auto">
