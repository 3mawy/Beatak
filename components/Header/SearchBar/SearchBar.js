...
function SearchBar(props) {
    ...
    return (
        <div className={` w-full ps-4 justify-start flex min-w-0 ${props.className}`}>
                ...
                <input type="text" className="py-2 placeholder:md:text-sm placeholder:text-xs placeholder:text-gray400  placeholder:dark:text-gray300 bg-transparent w-full rounded-full" placeholder={t('search')}/>
                <SearchBarSelect/>
            </div>
