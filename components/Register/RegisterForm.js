            ...
            <div className="min-h-full flex flex-col justify-center py-10 sm:px-6 lg:px-8">
                <div className="">
                    <img
                        ...
                        alt="Workflow"
                    />
                    <h2 className="mt-3 text-center text-3xl font-extrabold ">{t('sign in to your account')}</h2>
                        ...
                        <div className="mt-6">
                            <div className="relative">
                                ...
                                <div className="relative flex justify-center text-sm">
                                    <span
                                        className="px-2 bg-gray100 dark:bg-dark300 text-gray-500">{t('or continue with')}</span>
                                </div>
                            </div>
